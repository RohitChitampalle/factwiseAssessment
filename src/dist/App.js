...
var App = function () {
    ...
    return (react_1["default"].createElement("div", null,
        ...
        filteredCelebrities.map(function (celebrity, index) { return (react_1["default"].createElement(CelebritiesAccordion_1["default"], { key: index, celebrity: celebrity, onDelete: handleDelete })); })));
};
exports["default"] = App;
